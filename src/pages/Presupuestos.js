                ...
                <div className="card border-0 shadow-sm h-100">
                    ...
                    <div className="card-body">
                        <div className="row text-center g-3">
                            <div className="col-6">
                                <div className="border rounded p-3 animate__fadeIn animate__faster">
                        ...
                        <div className="mt-3 animate__fadeIn animate__faster">
                        ...
                        <div className="row text-center g-3">
                            <div className="col-6">
                                <div className="border rounded p-3 animate__fadeIn animate__faster">
                                    ...
                                    <h4 className="text-success mb-0">{savingsSummary.totalGoals}</h4>
                                </div>
                            </div>
                            <div className="col-6">
                                <div className="border rounded p-3 animate__fadeIn animate__faster">
                                    <h6 className="text-muted mb-1">Completadas</h6>
                                    <h4 className="text-primary mb-0">{savingsSummary.completedGoals}</h4>
                                </div>
                            </div>
                            <div className="col-6">
                                <div className="border rounded p-3 animate__fadeIn animate__faster">
                                    <h6 className="text-muted mb-1">Meta Total</h6>
                    ...
                    <div className="card border-0 shadow-sm">
                        ...
                        <div className="card-body">
                            <div className="row g-3">
                                {unreadAlerts.slice(0, 3).map((alert, index) => (
                                    <div key={index} className="col-md-4">
                                        <div className={`alert alert-${alert.type} mb-0 d-flex align-items-center animate__fadeIn animate__faster`}>
                                            <FaExclamationTriangle className="me-2" />
                            ...
                            {unreadAlerts.length > 3 && (
                                <div className="text-center mt-3 animate__fadeIn animate__faster">
                                    <button
