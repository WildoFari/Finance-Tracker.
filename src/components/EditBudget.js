...
const EditBudget = ({ show, onClose, budget }) => {
    ...
    // Cargar datos del presupuesto cuando se abre el modal
    useEffect(() => {
        if (budget) {
            setFormData({
                category: budget.category,
                limit: new Intl.NumberFormat('es-ES').format(budget.limit),
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            updateBudget(budget.id, {
                ...
                limit: parseFloat(formData.limit.replace(/\./g, '')),
